...
<html>
  ...
  <body style="background-image:url(images/bg.jpg);height:100%;">
   <div class="ban nav">
      ...
      <div class="content addContent">云&nbsp;&nbsp;尚&nbsp;&nbsp;商&nbsp;&nbsp;家&nbsp;&nbsp;产&nbsp;&nbsp;品&nbsp;&nbsp;管&nbsp;&nbsp;理</div>
   </div>
   <div class="contain ban" style="overflow:hidden;">
      <div class="sidebar">
        <div><img src="images/ad.jpg" alt="分类"/><span>&nbsp;&nbsp;&nbsp;&nbsp;选择功能：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
        <div><ul>
          <li style="background:#41c7db;margin-top:20px;">功能</li><li><a href="#shangjia">商家产品管理</a></li>
        </ul></div>
        <div><img src="images/zhuzi.jpg" style="width:155px;height:300px;"/></div>
      </div>
      <div class="bigbox">
        <div class="bigtitle">商家产品管理</div>
        <div class="smallbox" style="border-top:1px solid #cccccc;">
          <div class="smalltitle" id="shangjia">商家产品管理</div>
          <div>
             <form action="SellerProduct.do" method="post" enctype="multipart/form-data">
                <p style="margin-top:40px;"><label for="nam">商家名称</label> <input type="text" class="inputtest" id="nam" name="SellerName" value="${SellerName}"/></p>
                <p><label for="goodsnam">产品名称</label> <input type="text" class="inputtest" id="goodsnam" name="ProductName"/></p>
                <p><label for="goodsint">产品介绍</label> <input type="text" class="inputtest" id="goodint" name="ProductIntroduce"/></p>
                <p><label for="price">产品价格</label> <input type="text" class="inputtest" id="price" name="ProductPrice"/></p>
                <p style="position:relative;left:-24px;"><label for="picture">产品图片</label> <input type="file" id="picture" name="file"/></p>
