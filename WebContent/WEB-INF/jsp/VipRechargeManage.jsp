...
<html>
  <head>
	...
	<meta http-equiv="keywords" content="云尚刷卡积分管理系统会员充值管理">
	<meta http-equiv="description" content="云尚刷卡积分管理系统会员充值管理">
  ...
  <body>
   <div class="ban nav">
      ...
      <div class="content addContent">会&nbsp;&nbsp;员&nbsp;&nbsp;充&nbsp;&nbsp;值&nbsp;&nbsp;管&nbsp;&nbsp;理</div>
   </div>
   <div class="contain ban" style="overflow:hidden;">
      <div class="sidebar">
        <div><img src="images/ad.jpg" alt="分类"/><span>&nbsp;&nbsp;&nbsp;&nbsp;选择功能：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
        <div><ul>
          <li style="background:#41c7db;margin-top:20px;">功能</li><li><a href="#perfect">会员充值管理</a></li>
        </ul></div>
        <div><img src="images/zhuzi.jpg" style="width:155px;height:300px;"/></div>
      </div>
      <div class="bigbox">
        <div class="bigtitle">会员充值管理</div>
        <div class="smallbox" style="border-top:1px solid #cccccc;">
          <div class="smalltitle" id="perfect">填写充值会员姓名</div>
           <div>
             <form action="IntoVipRechargeFillIn.do" method="post">
               <ul>
          ...
          <div class="smalltitle" id="perfect">填写会员充值信息</div>
          <div>
             <form action="VipRecharge.do" method="post">
               <ul>
                <li style="margin-top:40px;"><span>会员姓名</span><input type="text" class="inputtest" name="VipName" value="${VipConsumeInfo.vipName}"/></li>
                <br>
                <li><span>余额</span><input class="inputtest" name="Integral" value="${VipConsumeInfo.balance}" disabled/></li>
                <li><span>充值金额</span><input type="text" class="inputtest" name="RechargeMoney"/></li>
