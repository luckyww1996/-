...
<html>
  <head>
    <title>云尚商家会员管理</title>
	<meta http-equiv="pragma" content="no-cache">
	<meta http-equiv="cache-control" content="no-cache">
	<meta http-equiv="expires" content="0">    
	<meta http-equiv="keywords" content="云尚刷卡积分管理系统商家会员管理">
	<meta http-equiv="description" content="云尚刷卡积分管理商家会员管理">
  ...
  <body style="background-image:url(images/bg.jpg);height:100%;">
   <div class="ban nav">
      ...
      <div class="content addContent">云&nbsp;&nbsp;尚&nbsp;&nbsp;商&nbsp;&nbsp;家&nbsp;&nbsp;会&nbsp;&nbsp;员&nbsp;&nbsp;管&nbsp;&nbsp;理</div>
   </div>
   <div class="contain ban" style="overflow:hidden;">
      <div class="sidebar">
        <div><img src="images/ad.jpg" alt="分类"/><span>&nbsp;&nbsp;&nbsp;&nbsp;选择功能：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></div>
        <div><ul>
          <li style="background:#41c7db;margin-top:20px;">功能</li><li><a href="#dengji">会员基本信息登记</a></li>
        </ul></div>
        <div><img src="images/zhuzi.jpg" style="width:155px;height:300px;"/></div>
      </div>
      <div class="bigbox">
        <div class="bigtitle">商家会员管理</div>
        <div class="smallbox" style="border-top:1px solid #cccccc;">
          <div class="smalltitle" id="dengji">会员基本信息登记</div>
          <form action="SellerVip.do" method="post">
               <ul>
                <li style="margin-top:40px;"><span>商家名称</span><input class="inputtest" required type="text" name="SellerName" value="${SellerName}" disabled/></li>
                <li><span>身份证号</span><input class="inputtest" required type="text" name="IdCardNumber"/></li>
                <li><span>会员姓名</span><input class="inputtest" type="text" name="VipName"/></li>
                <li><span>会员性别</span><input type="text" class="inputtest" placeholder="请输入男或女" name="VipSex"/></li>
                <li><span>联系电话</span><input type="text" class="inputtest" name="VipPhone"/></li>
                <li><span>家庭住址 </span><input type="text" class="inputtest" name="VipAddress"/></li>
                <li><span>&nbsp;&nbsp;邮&nbsp;&nbsp;&nbsp;箱</span><input type="text" class="inputtest" name="VipEmail"/></li>
