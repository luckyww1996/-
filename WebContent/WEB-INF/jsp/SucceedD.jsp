...
<html >
 ...
 <body>
 <div class="bg">
    <form action="SellerManage.do" method="post">
    <div class="line"><input type="text" class="in"style="font-family:'Microsoft YaHei';font-size:18px;background:transparent;" value="信息修改成功，点击返回继续操作" onfocus="this.blur()"><div> 
    <br/><br/><br/><br/>
