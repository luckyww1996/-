...
<html >
 ...
 <body>
 <div class="bg">
    <form action="IntoSellerInfoMaintain.do" method="post">
    <div class="line"><input type="text" class="in"style="font-family:'Microsoft YaHei';font-size:18px;background:transparent;" value="信息更新成功，点击返回查看" onfocus="this.blur()"><div> 
    <br/><br/><br/><br/>
