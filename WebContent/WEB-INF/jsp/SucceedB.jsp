...
<html >
 ...
 <div class="bg">
    ...
    <div class="line"><input type="text" class="in"style="font-family:'Microsoft YaHei';font-size:18px;background:transparent;" value="提交成功，点击返回继续操作" onfocus="this.blur()"><div> 
    <br/><br/><br/><br/>
