...
<html >
 ...
 <body>
 <div class="bg">
    <form action="ApplyInfoQuery.do" method="post">
    <div class="line"><input type="text" class="in"style="font-family:'Microsoft YaHei';font-size:18px;background:transparent;" value="成功分配账号，点击返回继续操作" onfocus="this.blur()"><div> 
    <br/><br/><br/><br/>
