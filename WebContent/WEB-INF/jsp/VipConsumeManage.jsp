...
<html>
  <head>
	...
	<meta http-equiv="keywords" content="云尚刷卡积分管理系统会员消费管理">
	<meta http-equiv="description" content="云尚刷卡积分管理系统会员消费管理">
   ...
   <div class="contain ban" style="overflow:hidden;">
      ...
      <div class="bigbox">
        ...
        <div class="smallbox" style="border-top:1px solid #cccccc;">
          ...
          <div class="smalltitle" id="perfect">填写会员消费信息</div>
          <div>
             <form action="VipConsumeManage.do" method="post">
               <ul>
                ...
                <li><span>消费金额</span><input type="text" class="inputtest" name="ConsumeMoney"/></li>
                <li><span>可得积分</span><input type="text" class="inputtest" name="AvailableIntegral"/></li>
